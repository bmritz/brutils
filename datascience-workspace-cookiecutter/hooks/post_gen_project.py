...
# This can be used to automatically create a github repo -- disable  For now
#g = GitHub(user, password)
#g.user.repos.post(name="{{cookiecutter.repo_name}}", description="{{cookiecutter.description}}")
